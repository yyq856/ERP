...
CREATE TABLE erp_account (
                             id BIGINT PRIMARY KEY AUTO_INCREMENT COMMENT '账号',
...
CREATE TABLE erp_customer (
                              ...
                              first_name VARCHAR(60) COMMENT '名字（person类型）',
                              last_name VARCHAR(60) COMMENT '姓氏（person类型）',
                              bp_type VARCHAR(10) NOT NULL DEFAULT 'org' COMMENT '业务伙伴类型：person/org/group',
                              search_term VARCHAR(60) COMMENT '搜索词',
