...
public class ItemValidationResponse {
    ...
    private ItemValidationData data;
    ...
    @NoArgsConstructor
    @AllArgsConstructor
    public static class ItemValidationData {
    ...
    public static class ItemBreakdown {
        ...
        private String reqDelivDate;           // 送货日期
        ...
        private String pricingDate;            // 日期
        private String orderProbability;       // 默认值，100或者返回用户输入的值
